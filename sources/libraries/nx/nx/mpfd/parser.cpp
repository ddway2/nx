...
void MPFD::parser::content_type(const std::string& type) {
...
void MPFD::parser::_ParseHeaders(std::string headers) {
    ...
    if (name_pos == std::string::npos) {
        ...
        auto name_end_pos = headers.find("\"", name_pos + 6);
        ...
        if (filename_pos == std::string::npos) {
            ...
            auto filename_end_pos = headers.find("\"", filename_pos + 10);
            ...
            if (content_type_pos != std::string::npos) {
                ...
                for (auto i = content_type_pos + 14; (i < headers.length()) && (!content_type_end_pos); i++) {
